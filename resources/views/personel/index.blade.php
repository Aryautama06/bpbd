                ...
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white/10 backdrop-blur-lg rounded-xl p-6">
                            ...
                            <p class="text-2xl font-bold text-white">{{ $personel->total }}</p>
                        </div>

                        <!-- Personel Aktif -->
                        <div class="bg-white/10 backdrop-blur-lg rounded-xl p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-white">Personel Aktif</h3>
                            ...
                            <p class="text-2xl font-bold text-white">{{ $personel->aktif }}</p>
                        </div>

                        <!-- Personel Non-Aktif -->
                        <div class="bg-white/10 backdrop-blur-lg rounded-xl p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-white">Non-Aktif</h3>
                            ...
                            <p class="text-2xl font-bold text-white">{{ $personel->non_aktif }}</p>
                        </div>

                        <!-- Dalam Tugas -->
                        <div class="bg-white/10 backdrop-blur-lg rounded-xl p-6">
                            <div class="flex items-center justify-between mb-4">
                                <h3 class="text-lg font-semibold text-white">Dalam Tugas</h3>
                            ...
                            <p class="text-2xl font-bold text-white">{{ $personel->bertugas }}</p>
                        </div>
                    </div>
                </div>
            </div>
