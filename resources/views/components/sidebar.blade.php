    ...
    <nav class="flex-1 overflow-y-auto py-4 px-4 space-y-4 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
        ...
        <div x-data="{ open: false }">
            <button @click="open = !open" 
                    class="flex items-center w-full px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-lg group">
                <svg class="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                          d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                </svg>
                <span class="flex-1 text-left">Riwayat</span>
            ...
            <div x-show="open" class="pl-6 mt-1 space-y-1">
                <a href="{{ route('perhitungan.riwayat') }}" 
                   class="flex items-center px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-lg">
