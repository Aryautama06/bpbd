...
<head>
    ...
    <head>
        <title>Detail Kriteria - {{ $kriteria->nama_kriteria }} - BPBD</title>
                        ...
                        <div class="max-w-7xl mx-auto">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h1 class="text-2xl font-bold text-white">{{ $kriteria->nama_kriteria }}</h1>
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <form action="{{ route('kriteria.destroy', ['kriteria' => $kriteria->id]) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                                <div class="p-6">
                                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Informasi Kriteria</h2>
                                    <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                                        <div>
                                            <dt class="text-sm font-medium text-gray-500">Jenis Kriteria</dt>
                                            <dd class="mt-1">
                                    ...
                                    <div class="px-6 py-4">
                                        <div class="text-sm text-gray-500">
                                            <div class="flex items-center gap-2 mb-2">
                                                ...
                                                Dibuat: {{ $kriteria->created_at->format('d F Y H:i') }}
                                            </div>
                                            <div class="flex items-center gap-2">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                </svg>
                                                Terakhir diperbarui: {{ $kriteria->updated_at->diffForHumans() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
