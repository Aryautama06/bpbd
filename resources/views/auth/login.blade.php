                ...
                <div class="bg-white/80 backdrop-blur-xl shadow-2xl rounded-2xl overflow-hidden animate__animated animate__fadeInRight border border-white/20">
                    ...
                    <div id="login-form" class="p-8">
                        ...
                        <div class="mb-6 animate__animated animate__fadeIn">
                            <div class="relative px-4 py-3 leading-normal text-green-700 bg-green-100 rounded-lg">
                    ...
                    <div id="register-form" class="hidden p-8">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="space-y-6">
                            ...
                            <button type="submit" 
                                    class="button-text w-full bg-gradient-to-r from-bpbd-primary to-bpbd-secondary text-white py-3 rounded-xl hover:from-bpbd-primary/90 hover:to-bpbd-secondary/90 transform hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-xl"
                                    onclick="this.classList.add('opacity-75', 'cursor-wait'); this.innerHTML='<span class=\'flex items-center justify-center\'><svg class=\'animate-spin -ml-1 mr-3 h-5 w-5 text-white\' xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 24 24\'><circle class=\'opacity-25\' cx=\'12\' cy=\'12\' r=\'10\' stroke=\'currentColor\' stroke-width=\'4\'></circle><path class=\'opacity-75\' fill=\'currentColor\' d=\'M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z\'></path></svg>Mendaftar...</span>';">
                                <span class="flex items-center justify-center">
